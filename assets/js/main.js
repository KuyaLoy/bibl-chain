...
$(document).ready(function(){
    $('.nav-link').on("click",function(){
     ...
     // hide and show navbar btw scroll down and scroll up
      var lastScrollTop = 0, delta = 5;
      $(window).scroll(function(){
          var nowScrollTop = $(this).scrollTop();

          if( nowScrollTop == 0){
            $(".header-area").css({"background":"transparent","box-shadow":"none"});
        }
          if(Math.abs(lastScrollTop - nowScrollTop) >= delta){
              if (nowScrollTop > lastScrollTop){
                  // SCROLLING DOWN 
                $(".header-area").css({"top":"-107px","background-color":"#f9f9f9","box-shadow":"rgba(0, 0, 0, 0.1) 5px 4px 10px"});
              } else {
                  // SCROLLING UP 
      ...
      $('.im_portfolio').hover(function(){
        $(this).find(".portfolio_heading").css({"margin-bottom":"65px"});
      },function(){
        $(this).find(".portfolio_heading").css({"margin-bottom":"0px"});
      })    
});
